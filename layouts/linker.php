...
<head>
    <meta charset="utf-8">
    <title>AFSBF - Arfan Familys Smiling Baby Foundation</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <!-- Favicon -->
    <link href="<?php echo ($ROOT . '/assets/img/logo/favicon.png') ?>" rel="icon">
    ...
    <link href="<?php echo ($ROOT . '/assets/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css') ?>" rel="stylesheet" />
