    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center px-3">Project Details</h6>
                <h1 class="mb-5 text-primary">Our Project Details</h1>
            </div>
            <div class="row justify-content-center g-4 wow fadeInUp" data-wow-delay="0.1s">
                <?php
                if (isset($_GET['id'])) {
                    $id = $_GET['id'];
                    $select_from_new_paper = "SELECT * FROM `projects` WHERE `id`='$id'";
                    $run_select_from_new_paper = mysqli_query($conn, $select_from_new_paper);
                    if (mysqli_num_rows($run_select_from_new_paper) > 0) {
                        $row = mysqli_fetch_assoc($run_select_from_new_paper);
                        extract($row);
                        $imgIndex = 0;
                        $images = json_decode($image_gallery, true);
                ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row justify-content-center align-items-center">
                                        ...
                                        ?>
                                                <div class="col-md-3 mb-4" style="height: 30vh">
                                                    <img src="<?php echo ($ROOT . '/assets/img/project/gallery/' . $images[$imgIndex]) ?>" alt="vc_img" class="card-img-top" style="height: 100%; width: 100%; object-fit: cover;">
                                                </div>
                                            <?php
                                                $imgIndex++;
                                            }
                                            ...
                                            <div class="col-md-3" style="height: 30vh">
                                                <img src="<?php echo ($ROOT . '/assets/img/project/gallery/' . $image_gallery) ?>" alt="vc_img" class="card-img-top" style="height: 100%; width: 100%; object-fit: cover;">
                                            </div>
                                        <?php
                                        }
                                        ?>
