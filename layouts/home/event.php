...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="mb-5 text-primary">Upcoming Events</h1>
        </div>
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="package-item">
                    ...
                    <div class="p-4">
                        <span class="fw-bold" style="color: #ff6d02">23 - 24 Feb 2024</span>
                        ...
                        <div class="d-flex justify-content-start mb-2">
                            <a href="<?php echo ($ROOT . '/layouts/event/details?id=' . $id) ?>" class="btn-style">Read More</a>
                            <!-- <a href="<?php echo ($ROOT . '/layouts/event/details?id=' . $id) ?>" class="btn btn-sm btn-primary px-3" style="border-radius: 0 30px 30px 0;">Book Now</a> -->
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-center mt-3 wow fadeInUp" data-wow-delay="0.9s">
            <a href="<?php echo ($ROOT . '/layouts/event') ?>"><button class="btn-style" style="border-radius: 30px 30px;">Other Events</button></a>
        </div>
    </div>
</div>
<!-- Package End -->