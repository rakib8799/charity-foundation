...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h6 class="section-title bg-white text-center px-3">Volunteers</h6>
            <h1 class="mb-5 text-primary">Meet Our Volunteers</h1>
        </div>
        ...
        <div class="d-flex justify-content-center wow fadeInUp" data-wow-delay="0.9s">
            <button class="btn-style mt-4" style="border-radius: 30px 30px;">Join Now</button>
        </div>
    </div>
</div>
<!-- Team End -->